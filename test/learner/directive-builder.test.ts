...
describe('directive-builder', () => {
  ...
  describe('buildDirectiveBodyFromInput', () => {
    ...
    it('body contains "_AI analysis: …_" line when llmSummary provided', () => {
      const result = buildDirectiveBodyFromInput({
        turnsTotalSeen: 10,
        agentRoster: ['main'],
        nowIso: '2026-04-14T22:20:00Z',
    ...
    it('no "_AI analysis:_" line when llmSummary omitted (backwards compat)', () => {
      const result = buildDirectiveBodyFromInput({
        turnsTotalSeen: 10,
        agentRoster: ['main'],
        nowIso: '2026-04-14T22:20:00Z',
      ...
      expect(result.body).not.toContain('AI analysis:');
    });

    it('empty/whitespace llmSummary treated as omitted', () => {
      const result = buildDirectiveBodyFromInput({
        turnsTotalSeen: 10,
        agentRoster: ['main'],
        nowIso: '2026-04-14T22:20:00Z',
    ...
    it('llmSummary with newlines is collapsed to single line (injection resistance)', () => {
      const result = buildDirectiveBodyFromInput({
        turnsTotalSeen: 10,
        agentRoster: ['main'],
        nowIso: '2026-04-14T22:20:00Z',
    ...
    it('SEC-001: llmSummary with GENERATED comment marker is sanitized', () => {
      const malicious = 'Summary <!-- GENERATED by evil --> trailing';
      const result = buildDirectiveBodyFromInput({
        turnsTotalSeen: 10,
        agentRoster: ['main'],
        nowIso: '2026-04-14T22:20:00Z',
